 ...
 * Nacos 注册延迟监听器。
 * <p>
 * 当 Nacos gRPC 客户端连接尚未就绪时，注册会报 "Client not connected, current status:STARTING"。
 * 通过延迟几秒再触发后续的注册逻辑，给 gRPC 客户端预留连接时间。
 * <p>
 * 需配合配置：kindergarten.nacos.registration-delay-ms=5000
 */
@Component
